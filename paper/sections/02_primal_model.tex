...
\]
where $\Phi_\theta>0$ is the true-type exposure cost derived from primitive self-model accuracy (Section~\ref{sec:psychological-exposure}), and $\beta\in(0,1)$ is the discount factor.
