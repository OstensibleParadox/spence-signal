...
\right].
\]
Low-scrutiny and current epistemic costs are already absorbed into \(B_\theta(\rho)\); \(\Gamma(q,\eta)\) prices only the marginal future adverse-repricing exposure created by entering high scrutiny.
